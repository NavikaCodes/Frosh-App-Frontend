...
const rooms = [
  { id: 1, name: 'Ambaram Hall', image: require('../assets/cos.avif') },
  { id: 2, name: 'Tejas Hall', image: require('../assets/cos.avif') },
  { id: 3, name: 'Vyan Hall', image: require('../assets/cos.avif') },
  { id: 4, name: 'Neeram Hall', image: require('../assets/cos.avif') },
  { id: 5, name: 'Prithvi Hall', image: require('../assets/cos.avif') },
  { id: 6, name: 'Amritam Hall', image: require('../assets/cos.avif') },
  { id: 7, name: 'Vyom Hall', image: require('../assets/cos.avif') },
  { id: 8, name: 'Anantam Hall', image: require('../assets/cos.avif') },
  { id: 9, name: 'Viyat Hall', image: require('../assets/cos.avif') },
];
